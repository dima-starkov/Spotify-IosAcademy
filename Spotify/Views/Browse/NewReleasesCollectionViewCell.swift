...
class NewReleasesCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        let albumLabelSize = albumNameLabel.sizeThatFits(CGSize(width: contentView.widht - imageSize - 10,
        ...
        artistNameLabel.frame = CGRect(x: albumCoverImageView.right + 10,
                                       ...
                                       width: contentView.widht - albumCoverImageView.right - 5,
                               height: 30)
        
        numberOfTracksLabel.frame = CGRect(x: albumCoverImageView.right + 10,
                               y: contentView.bottom - 44,
                               width: numberOfTracksLabel.widht,
                               height: 44)
    }
