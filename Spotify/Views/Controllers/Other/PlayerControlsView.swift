...
final class PlayerControlsView: UIView {
    ...
    @objc func didSlideSlider(_ slider: UISlider) {
        ...
        delegate?.PlayerControlsViewVol(self, didSlideSlider: value)
    }
    ...
    override func layoutSubviews() {
        ...
        nameLabel.frame = CGRect(x: 0, y: 0, width: widht, height: 50)
        subtitleLabel.frame = CGRect(x: 0, y: nameLabel.bottom + 10, width: widht, height: 50)
        
        volumeSlider.frame = CGRect(x: 10, y: subtitleLabel.bottom + 20, width: widht - 20, height: 44)
        
        
        let buttonSize: CGFloat = 60
        playPauseButton.frame = CGRect(x: (widht - buttonSize)/2, y: volumeSlider.bottom + 30, width: buttonSize, height: buttonSize)
